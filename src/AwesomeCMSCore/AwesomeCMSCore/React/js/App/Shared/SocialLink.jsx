...
import {isDomsExist} from "Helper/Util";
...
if (isDomsExist("social-link-element")) {
	render(
		<SocialLink/>, document.getElementsByClassName("social-link-element")[0]);
	render(
		<SocialLink/>, document.getElementsByClassName("social-link-element")[1]);
}