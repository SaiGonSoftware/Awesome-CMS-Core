										...
										<div className="row">
												<div className="col-lg-5 col-md-5 col-sm-5 col-xs-12">
														<div className="post-image">
																<img src="./Optimistic Blog Index_files/post-eight.jpeg" alt="...."/>
														</div>
												</div>
												<div className="col-lg-7 col-md-7 col-sm-7 col-xs-12">
														...
														<div className="post-meta-posted-date">
																<p>
																		<a href="https://offshorethemes.com/html/optimistic-blog/demo/index-two.php#">{props.post.dateCreated}</a>
																</p>
														</div>
