																		...
																		<div className="widget-social-links">
																				<ul className="social-links-list">
																						<li className="facebook-link">
																								<a href="http://facebook.com/" className="clearfix"  rel="noopener">
																										Facebook
																						...
																						<li className="twitter-link">
																								<a href="http://twitter.com/" className="clearfix"  rel="noopener">
																										Twitter
																										<span className="social-icon">
																						...
																						<li className="googleplus-link">
																								<a href="http://plus.google.com/" className="clearfix"  rel="noopener">
																										Google Plus
																										<span className="social-icon">
																						...
																						<li className="instagram-link">
																								<a href="http://instagram.com/" className="clearfix"  rel="noopener">
																										Instagram
																										<span className="social-icon">
																						...
																						<li className="linkedin-link">
																								<a href="http://linkedin.com/" className="clearfix"  rel="noopener">
																										Linked In
																										<span className="social-icon">
																						...
																						<li className="youtube-link">
																								<a href="http://youtube.com/" className="clearfix"  rel="noopener">
																										Youtube
																										<span className="social-icon">
